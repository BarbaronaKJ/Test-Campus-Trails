...
export const styles = StyleSheet.create({
  ...
  notificationDetailTypeIcon: {
    fontSize: 16,
    marginRight: 6,
  },
  notificationDetailTypeText: {
    fontSize: 12,
    fontWeight: '600',
    color: '#34495e',
    textTransform: 'capitalize',
  },
  notificationDetailMainTitle: {
    fontSize: 22,
    fontWeight: '700',
    color: '#2c3e50',
    marginBottom: 12,
  ...
  notificationDetailMetadataTitle: {
    fontSize: 16,
    fontWeight: '600',
    color: '#2c3e50',
    marginBottom: 12,
  },
  notificationDetailMetadataRow: {
    flexDirection: 'row',
    marginBottom: 8,
  },
  notificationDetailMetadataLabel: {
    fontWeight: '600',
    color: '#555',
    marginRight: 8,
  },
  notificationDetailMetadataValue: {
    color: '#666',
    flex: 1,
  },
  notificationViewMapButton: {
